...
- [Перше налаштування](docs/first-time-setup/index.md)
  ...
  5. [Обов'язкова конфігурація обладнання](docs/first-time-setup/mandatory-hardware.md)
     ...
     - [Тип frame](docs/first-time-setup/frame-type.md)
       - [Вибір frame](docs/first-time-setup/choosing-a-frame.md)
       - [Традиційні гелікоптери](docs/first-time-setup/traditional-helicopters.md)
       - [HeliQuads](docs/first-time-setup/heliquads.md)
       - [Tricopter](docs/first-time-setup/tricopter.md)
       - [SingleCopter і CoaxCopter](docs/first-time-setup/singlecopter-and-coaxcopter.md)
     - [Підключення ESC і моторів](docs/first-time-setup/connect-escs-and-motors.md)
     ...
     - [Температурне калібрування IMU](docs/first-time-setup/imu-temperature-calibration.md)
     ...
     - [Додаткове обладнання](docs/first-time-setup/optional-hardware.md)
- [Безпека](docs/safety/index.md)
  1. [Arming the motors](docs/safety/arming.md)
  2. [Перевірки pre-arm](docs/safety/prearm-checks.md)
  3. [Failsafe](docs/safety/index.md)
     - [Radio failsafe](docs/safety/radio-failsafe.md)
     - [Battery failsafe](docs/safety/battery-failsafe.md)
     - [GCS failsafe](docs/safety/gcs-failsafe.md)
     - [EKF failsafe](docs/safety/ekf-failsafe.md)
     - [Dead reckoning failsafe](docs/safety/dead-reckoning-failsafe.md)
     - [Vibration failsafe](docs/safety/vibration-failsafe.md)
     - [Terrain following](docs/safety/terrain-following.md)
     - [Crash check](docs/safety/crash-check.md)
     - [Парашут](docs/safety/parachute.md)
     - [Watchdog і crash dump](docs/safety/watchdog.md)
- [Перший політ](docs/first-flight/index.md)
  1. [Передпольотний чекліст](docs/first-flight/checklist.md)
  2. [Поради для початківців](docs/first-flight/tips.md)
  3. [Throttle висіння](docs/first-flight/hover-throttle.md)
  4. [AutoTrim](docs/first-flight/autotrim.md)
  5. [Втрата тяги і дисбаланс yaw](docs/first-flight/thrust-loss-yaw-imbalance.md)
  6. [Польоти в приміщенні](docs/first-flight/indoor-flying.md)
  7. [Акробатичний мультикоптер](docs/first-flight/aerobatic-multicopter.md)
  8. [Агресивний tuning контуру швидкостей](docs/first-flight/high-loop-rate-tuning.md)
- [Tuning](docs/tuning/index.md)
  1. [Процес tuning](docs/tuning/process.md)
  2. [Підготовка до tuning](docs/tuning/setup.md)
  3. [Перший політ для tuning](docs/tuning/initial-flight.md)
  4. [Оцінювання tuning](docs/tuning/evaluating.md)
  5. [Ручний tuning roll і pitch](docs/tuning/manual-roll-pitch.md)
  6. [QuikTune](docs/tuning/quiktune.md)
  7. [AutoTune](docs/tuning/autotune.md)
  8. [Input Shaping](docs/tuning/input-shaping.md)
  9. [Throttle Boost](docs/tuning/throttle-boost.md)
  10. [Tuning з RC transmitter](docs/tuning/transmitter-tuning.md)
  11. [Ground resonance](docs/tuning/ground-resonance.md)
  12. [Вимірювання вібрацій](docs/tuning/measuring-vibration.md)
  13. [Notch-фільтри](docs/tuning/notch-filtering.md)
     - [За throttle](docs/tuning/notch-throttle.md)
     - [За датчиком обертів](docs/tuning/notch-rpm.md)
     - [За ESC telemetry](docs/tuning/notch-esc.md)
     - [Гелікоптери](docs/tuning/notch-heli.md)
     - [Raw IMU Logging](docs/tuning/raw-imu-logging.md)
     - [IMU Batch Sampler](docs/tuning/batch-sampling.md)
  14. [FFT у польоті](docs/tuning/fft.md)
     - [Перший політ для аналізу](docs/tuning/fft-test-flight.md)
     - [Розширене налаштування](docs/tuning/fft-advanced.md)
     - [Як це працює](docs/tuning/fft-how-it-works.md)
- [FPV](docs/fpv/index.md)
  1. Режими польоту FPV
     - [Acro](docs/fpv/acro-mode.md)
     - [AirMode](docs/fpv/airmode.md)
     - [Turtle](docs/fpv/turtle-mode.md)
     - [Flip](docs/fpv/flip-mode.md)
  2. ESC
     - [PWM, OneShot, OneShot125](docs/fpv/esc-pwm.md)
     - [DShot](docs/fpv/dshot.md)
     - [BLHeli32, AM32, BLHeli_S](docs/fpv/blheli.md)
     - [ESC telemetry](docs/fpv/esc-telemetry.md)
  3. Радіокерування
     - [Системи радіокерування](docs/fpv/rc-systems.md)
     - [Crossfire і ELRS](docs/fpv/crossfire-elrs.md)
     - [TBS Crossfire telemetry](docs/fpv/crsf-telemetry.md)
     - [FPort](docs/fpv/fport.md)
  4. Відео
     - [OSD](docs/fpv/osd.md)
     - [MSP OSD](docs/fpv/msp-osd.md)
     - [VTX](docs/fpv/vtx.md)
     - [HD-відео](docs/fpv/hd-video.md)
     - [RunCam](docs/fpv/runcam.md)
