...
- [Перший політ](first-flight/index.md)
    1. [Передпольотний чекліст](first-flight/checklist.md)
    2. [Поради для початківців](first-flight/tips.md)
    3. [Throttle висіння](first-flight/hover-throttle.md)
    4. [AutoTrim](first-flight/autotrim.md)
    5. [Втрата тяги і дисбаланс yaw](first-flight/thrust-loss-yaw-imbalance.md)
    6. [Польоти в приміщенні](first-flight/indoor-flying.md)
    7. [Акробатичний мультикоптер](first-flight/aerobatic-multicopter.md)
    8. [Агресивний tuning контуру швидкостей](first-flight/high-loop-rate-tuning.md)
- [Tuning](tuning/index.md)
    1. [Процес tuning](tuning/process.md)
    2. [Підготовка до tuning](tuning/setup.md)
    3. [Перший політ для tuning](tuning/initial-flight.md)
    4. [Оцінювання tuning](tuning/evaluating.md)
    5. [Ручний tuning roll і pitch](tuning/manual-roll-pitch.md)
    6. [QuikTune](tuning/quiktune.md)
    7. [AutoTune](tuning/autotune.md)
    8. [Input Shaping](tuning/input-shaping.md)
    9. [Throttle Boost](tuning/throttle-boost.md)
    10. [Tuning з RC transmitter](tuning/transmitter-tuning.md)
    11. [Ground resonance](tuning/ground-resonance.md)
    12. [Вимірювання вібрацій](tuning/measuring-vibration.md)
    13. [Notch-фільтри](tuning/notch-filtering.md)
        - [За throttle](tuning/notch-throttle.md)
        - [За датчиком обертів](tuning/notch-rpm.md)
        - [За ESC telemetry](tuning/notch-esc.md)
        - [Гелікоптери](tuning/notch-heli.md)
        - [Raw IMU Logging](tuning/raw-imu-logging.md)
        - [IMU Batch Sampler](tuning/batch-sampling.md)
    14. [FFT у польоті](tuning/fft.md)
        - [Перший політ для аналізу](tuning/fft-test-flight.md)
        - [Розширене налаштування](tuning/fft-advanced.md)
        - [Як це працює](tuning/fft-how-it-works.md)
- [FPV](fpv/index.md)
