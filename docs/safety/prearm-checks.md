...
| `CrashDump data detected` | Записано дані Crash Dump | Стався збій процесора, дані записано. Plane, ймовірно, небезпечно використовувати в польоті! Див. [crash_dump](watchdog.md#як-повідомити-про-watchdog--crash-dump) |
