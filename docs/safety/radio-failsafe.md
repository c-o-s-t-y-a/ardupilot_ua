...
- Якщо коптер armed у режимі Stabilize чи Acro, throttle на мінімумі, а апарат не в [AirMode](https://ardupilot.org/copter/docs/airmode.html) *(ще не перекладено)*, коптер одразу виконає disarm.
