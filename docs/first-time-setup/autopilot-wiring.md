...
Залежно від вашого обладнання може бути підключено ще будь-яку кількість периферії — датчики, камери, захоплювачі тощо. Вони описані на підсторінках розділу [Додаткове обладнання](optional-hardware.md).
