...
> Оригінал: [First Time Setup](https://ardupilot.org/copter/docs/initial-setup.html)
...
> **Порада.** Наступний розділ — [Перший політ](../first-flight/index.md) — пояснює, як почати літати на Copter, і яке подальше tuning (точне налаштування) та конфігурація потрібні новим системам.
